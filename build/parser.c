...
{
       0,    37,    37,    40,    41,    42,    43,    44,    45,    46,
      49,    50,    53,    54,    57,    62,    63,    66,    67
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LBRACK", "RBRACK", "COLON", "COMMA", "TRUE", "FALSE", "STRING",
  "NULLVAL", "NUMBER", "$accept", "json", "value", "object", "pairs",
  "pair", "array", "values", YY_NULLPTR
};
...
{
      14,     2,    -1,    -6,    -6,    -6,    -6,    -6,     7,    -6,
      -6,    -6,    -6,     8,    12,    -6,    -6,    -6,    -5,    -6,
      14,    -6,     3,    -6,    14,    -6,    -6,    -6
};
...
{
       0,     0,     0,     7,     8,     5,     9,     6,     0,     2,
       3,     4,    11,     0,     0,    12,    16,    17,     0,     1,
       0,    10,     0,    15,     0,    14,    13,    18
};
...
{
      17,    23,     1,    24,     2,    16,    12,    19,     3,     4,
       5,     6,     7,    13,    13,    20,    21,     1,    25,     2,
      22,     0,    27,     3,     4,     5,     6,     7,    26
};

static const yytype_int8 yycheck[] =
{
       2,     6,     3,     8,     5,     6,     4,     0,     9,    10,
      11,    12,    13,    11,    11,     7,     4,     3,    20,     5,
...
#line 49 "src/parser.y"
                            { (yyval.node) = create_object((yyvsp[-1].pair)); }
#line 1527 "build/parser.c"
    break;

  case 11: /* object: LBRACE RBRACE  */
#line 50 "src/parser.y"
                      { (yyval.node) = create_object(NULL); }
...
#line 54 "src/parser.y"
                        { (yyval.pair) = append_pair((yyvsp[-2].pair), (yyvsp[0].pair)); }
#line 1545 "build/parser.c"
    break;

  case 14: /* pair: STRING COLON value  */
#line 57 "src/parser.y"
                         {
        (yyval.pair) = create_pair((yyvsp[-2].strval), (yyvsp[0].node));
    }
#line 1553 "build/parser.c"
    break;

  case 15: /* array: LBRACK values RBRACK  */
#line 62 "src/parser.y"
                            { (yyval.node) = create_array((yyvsp[-1].nodelist)); }
#line 1559 "build/parser.c"
    break;

  case 16: /* array: LBRACK RBRACK  */
#line 63 "src/parser.y"
                     { (yyval.node) = create_array(NULL); }
#line 1565 "build/parser.c"
    break;

  case 17: /* values: value  */
#line 66 "src/parser.y"
              { (yyval.nodelist) = create_node_list((yyvsp[0].node)); }
#line 1571 "build/parser.c"
    break;

  case 18: /* values: values COMMA value  */
#line 67 "src/parser.y"
                           { (yyval.nodelist) = append_node_list((yyvsp[-2].nodelist), (yyvsp[0].node)); }
#line 1577 "build/parser.c"
    break;
